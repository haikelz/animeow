const TopMangaCards = (props) => {
  return (
    <>
      <div className="flex mt-12 justify-center items-center">
        <h1 className="text-4xl font-bold">Top <span className="text-[#9F72EA]">Manga</span></h1>
      </div>
      <div className="grid grid-cols-1 grid-rows-1 sm:grid-rows-2 sm:grid-cols-2 lg:grid-rows-3 lg:grid-cols-3 gap-4 px-4">
        {props.topManga.map(top => (
